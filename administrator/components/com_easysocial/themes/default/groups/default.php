							...
							<div class="media">
								...
								<div class="media-body">
									...
									<?php if( $this->tmpl != 'component' ){ ?>
										...
										<span class="label label-warning" data-original-title="<?php echo FD::_('COM_EASYSOCIAL_GROUPS_INVITE_GROUP_TOOLTIP' , true );?>" data-es-provide="tooltip" data-placement="top">
