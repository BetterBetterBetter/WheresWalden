 ...
 * View to edit
 */
class Geommunity3esViewMap extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		$canDo		= Geommunity3esBackendHelper::getActions();

		JToolBarHelper::title(JText::_('COM_GEOMMUNITY3ES_TITLE_MAP'), 'map.png');
