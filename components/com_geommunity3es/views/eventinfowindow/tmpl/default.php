        ...
        <div class="popbox-content" data-popbox-content="">
            ...
            <div class="profile-details">
                <div class="profile-title">
                    <a href="<?php echo $this->event_url ; ?>">
                        <?php echo JText::_('COM_GEOMMUNITY3ES_INT_EVENT').': '.ucfirst($this->title) ; ?>
                    </a>
                </div>
                <div class="profile-desp">
                    <?php 
					echo '<div>'.JText::_('COM_GEOMMUNITY3ES_FROM').' '.$this->start;
                    if($this->end >0)
                        echo ' '.JText::_('COM_GEOMMUNITY3ES_UNTILL').' '.$this->end;
                    echo '</div>';
                    ?>	
                </div>
            </div>
            ...
            <a class="es-avatar es-avatar-medium popbox-avatar" href="<?php echo $this->event_url ; ?>">
                    ...
                    <li>
                        <div class="popbox-item-info">
                                ...
                                <div class="popbox-item-text">
                                    <?php echo JText::_('COM_GEOMMUNITY3ES_EVENTCAT') ?>
                                </div>
                                <div class="popbox-item-total">
                                <?php  
			echo ucfirst($this->cattitle);
			?>
                                </div>
                    ...
                    <li>
                        <div class="popbox-item-info">
                                ...
                                <div class="popbox-item-text">
                                    <?php echo JText::_('COM_GEOMMUNITY3ES_ATTENDEES') ?>
                                </div>
                                <div class="popbox-item-total">
                                  <?php echo $this->attendees ?>
                                </div>
            ...
            <div class="popbox-footer">
                <div class="pull-left">
              <a href="<?php echo $this->profile_url; ?>"   ><?php echo JText::_('COM_GEOMMUNITY3ES_ADDEDBY'); ?> <i class="ies-user" title="<?php echo  ucfirst($this->naming) ; ?>" data-es-provide="tooltip"></i>  </a>
                </div>
                <div class="pull-right">
                    <div class="btn-group btn-group-pending">
                        <a class="btn-es btn-friends" href="<?php echo $this->event_url; ?>"  >
                         
                             <i class="ies-calendar ies-small mr-5"></i> <?php echo JText::_('COM_GEOMMUNITY3ES_VISITEVENT') ?>
