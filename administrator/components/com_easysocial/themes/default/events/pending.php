                    ...
                    <td>
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <?php if ($event->isOpen()){ ?>
                                <span class="label label-success mr-5" data-original-title="<?php echo FD::_('COM_EASYSOCIAL_EVENTS_OPEN_EVENT_TOOLTIP', true);?>" data-es-provide="tooltip" data-placement="top">
                                    <i class="ies-earth"></i> <?php echo JText::_('COM_EASYSOCIAL_EVENTS_OPEN_EVENT'); ?>
                                </span>
                                <?php } ?>

                                <?php if ($event->isClosed()){ ?>
                                <span class="label label-danger mr-5" data-original-title="<?php echo FD::_('COM_EASYSOCIAL_EVENTS_CLOSED_EVENT_TOOLTIP', true);?>" data-es-provide="tooltip" data-placement="top">
                                    <i class="ies-locked"></i> <?php echo JText::_('COM_EASYSOCIAL_EVENTS_CLOSED_EVENT'); ?>
                                </span>
                                <?php } ?>

                                <?php if ($event->isInviteOnly()){ ?>
                                <span class="label label-warning mr-5" data-original-title="<?php echo FD::_('COM_EASYSOCIAL_EVENTS_INVITE_EVENT_TOOLTIP', true);?>" data-es-provide="tooltip" data-placement="top">
                                    <i class="ies-locked"></i> <?php echo JText::_('COM_EASYSOCIAL_EVENTS_INVITE_EVENT'); ?>
                                </span>
                                <?php } ?>

                                <?php if ($event->isOver()) { ?>
                                <span class="label label-warning mr-5" data-original-title="<?php echo FD::_('COM_EASYSOCIAL_EVENTS_OVER_EVENT_TOOLTIP', true);?>" data-es-provide="tooltip" data-placement="top">
                                    <i class="ies-flag"></i> <?php echo JText::_('COM_EASYSOCIAL_EVENTS_OVER_EVENT'); ?>
                                </span>
                                <?php } ?>

                                <?php if ($event->isOngoing()) { ?>
                                <span class="label label-info mr-5" data-original-title="<?php echo FD::_('COM_EASYSOCIAL_EVENTS_ONGOING_EVENT_TOOLTIP', true);?>" data-es-provide="tooltip" data-placement="top">
                                    <i class="ies-flag"></i> <?php echo JText::_('COM_EASYSOCIAL_EVENTS_ONGOING_EVENT'); ?>
                                </span>
                                <?php } ?>

                                <?php if ($event->isUpcoming()) { ?>
                                <span class="label label-success mr-5" data-original-title="<?php echo FD::_('COM_EASYSOCIAL_EVENTS_UPCOMING_EVENT_TOOLTIP', true);?>" data-es-provide="tooltip" data-placement="top">
                                    <i class="ies-alarm"></i> <?php echo JText::_('COM_EASYSOCIAL_EVENTS_UPCOMING_EVENT'); ?>
                                </span>
                                <?php } ?>

                                <?php if ($event->isRecurring) { ?>
                                <span class="label label-warning mr-5" data-original-title="<?php echo FD::_('COM_EASYSOCIAL_EVENTS_RECURRING_EVENT_TOOLTIP', true);?>" data-es-provide="tooltip" data-placement="top">
